/*
	...
	$ cc -o server autoserver.c stdsoap2.c soapC.c soapServer.c

	Compilation in C++ (see samples/calc++):
	$ soapcpp2 -i auto.h
	$ cc -o autoclient++ autoclient.cpp stdsoap2.cpp soapC.cpp soapcalcProxy.cpp
	$ cc -o autoserver++ autoserver.cpp stdsoap2.cpp soapC.cpp soapcalcService.cpp
...
//gsoap ns service name:	setAuto
//gsoap ns service protocol:	SOAP
//gsoap ns service style:	rpc
//gsoap ns service encoding:	encoded
//gsoap ns service namespace:	urn:setAuto
//gsoap ns service location:	http://192.168.1.120:8080
//gsoap ns schema namespace:	urn:setAuto

//gsoap ns service method-documentation: setea direccion y sentido de auto
int ns__setAuto(double a, double b, double *result);
