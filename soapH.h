...
#ifndef SOAP_TYPE_ns__setAuto
#define SOAP_TYPE_ns__setAuto (11)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__setAuto(struct soap*, struct ns__setAuto *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__setAuto(struct soap*, const struct ns__setAuto *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__setAuto(struct soap*, const char*, int, const struct ns__setAuto *, const char*);
SOAP_FMAC3 struct ns__setAuto * SOAP_FMAC4 soap_in_ns__setAuto(struct soap*, const char*, struct ns__setAuto *, const char*);

#ifndef soap_write_ns__setAuto
#define soap_write_ns__setAuto(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__setAuto(soap, data), 0) || soap_put_ns__setAuto(soap, data, "ns:setAuto", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__setAuto(struct soap*, const struct ns__setAuto *, const char*, const char*);

#ifndef soap_read_ns__setAuto
#define soap_read_ns__setAuto(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__setAuto(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__setAuto * SOAP_FMAC4 soap_get_ns__setAuto(struct soap*, struct ns__setAuto *, const char*, const char*);

#ifndef SOAP_TYPE_ns__setAutoResponse
#define SOAP_TYPE_ns__setAutoResponse (10)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__setAutoResponse(struct soap*, struct ns__setAutoResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__setAutoResponse(struct soap*, const struct ns__setAutoResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__setAutoResponse(struct soap*, const char*, int, const struct ns__setAutoResponse *, const char*);
SOAP_FMAC3 struct ns__setAutoResponse * SOAP_FMAC4 soap_in_ns__setAutoResponse(struct soap*, const char*, struct ns__setAutoResponse *, const char*);

#ifndef soap_write_ns__setAutoResponse
#define soap_write_ns__setAutoResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__setAutoResponse(soap, data), 0) || soap_put_ns__setAutoResponse(soap, data, "ns:setAutoResponse", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__setAutoResponse(struct soap*, const struct ns__setAutoResponse *, const char*, const char*);

#ifndef soap_read_ns__setAutoResponse
#define soap_read_ns__setAutoResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__setAutoResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__setAutoResponse * SOAP_FMAC4 soap_get_ns__setAutoResponse(struct soap*, struct ns__setAutoResponse *, const char*, const char*);
