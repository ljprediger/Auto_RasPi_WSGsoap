...
SOAP_FMAC5 int SOAP_FMAC6 ns__setAuto(struct soap*, double a, double b, double *result);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__setAuto(struct soap*);
